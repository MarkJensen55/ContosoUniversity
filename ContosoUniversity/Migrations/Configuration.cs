...
DepartmentID = departments.Single( s => s.Name == "English").DepartmentID, 
            ...
            {
                new OfficeAssignment{ InstructorID= instructors.Single(i => i.LastName=="Fakhouri").InstructorID, 
                Location = "Smith 17",},
                new OfficeAssignment{ InstructorID= instructors.Single(i => i.LastName=="Harui").InstructorID, 
                Location = "Gowan 27",},
                new OfficeAssignment{ InstructorID= instructors.Single(i => i.LastName=="Kapoor").InstructorID, 
